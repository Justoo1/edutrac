...
import { ArrowUp, ArrowDown, DollarSign, Users, CreditCard, TrendingUp, Calendar, FileText, AlertTriangle, CheckCircle } from "lucide-react"
...
export function FinanceOverview() {
  const totalRevenue = 277000
  const totalExpenses = 214000
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-amber-600">GH₵45,300</div>
            <div className="flex items-center text-xs text-muted-foreground">
              <span className="text-amber-500">127 students</span>
